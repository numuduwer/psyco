...
<head>
	...
	<script type="text/javascript">
		...
		function payment() {
			...
			var merchant_uid = document.getElementById("itemNum").value;
			
			// IMP.request_pay(param, callback) 호출
			IMP.request_pay({ // param
				pg: "html5_inicis",
				payment_method: "card",					
				merchant_uid: merchant_uid,	// 주문 번호, 한번 결제 완료된 주문번호는 다시 사용할 수 없는 듯
				name: name,
				amount: 100,
				...
				if (response.success) {
					...
					$.ajax({
						url: "http://localhost:8080/psyco/member/buyPro.com",
						method: "post",
...
<body>
	<form name="pgForm">
		<input type="hidden" id="name" value="${dto.item_name}">
		<input type="hidden" id="itemNum" value="${dto.item_num}">
